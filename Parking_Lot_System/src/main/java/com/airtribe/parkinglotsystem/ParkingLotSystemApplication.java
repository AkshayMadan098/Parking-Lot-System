...
public class ParkingLotSystemApplication {
    ...
    public static void main(String[] args) throws InterruptedException, VehicleTypeNotSupportedException {
        ...
        Vehicle car = new Vehicle("KA25CA4324", VehicleType.CAR);
        Vehicle motorCycle = new Vehicle("KA25CA4324", VehicleType.MOTORCYCLE);
        Vehicle bus = new Vehicle("KA25CA4324", VehicleType.BUS);
        ...
        System.out.println("Parking System End----- ");
    }
}
